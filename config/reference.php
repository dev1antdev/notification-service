 ...
 * }
 * @psalm-type DeliveryRoutingConfig = array{
 *     channels: array<string, array{ // Default: []
 *         primary: scalar|null,
 *         fallbacks?: list<scalar|null>,
 *         switch_on?: list<scalar|null>,
 *         options?: list<mixed>,
 *     }>,
 * }
 * @psalm-type ProvidersConfig = array{
 *     sms?: array<string, list<mixed>>,
 *     email?: array<string, list<mixed>>,
 *     push?: array<string, list<mixed>>,
 *     webhook?: array<string, list<mixed>>,
 * }
 ...
 *     delivery_routing?: DeliveryRoutingConfig,
